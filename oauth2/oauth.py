...
class OauthHandler(webapp2.RequestHandler):
  def get(self):
    ...
    if statevar == memcache.get('authState'):
      ...
      payload ={
  	   'code': code,
	   'client_id': "5790331437-1hgqt51du3ad8t53ttcj76hek16aflpd.apps.googleusercontent.com",
	   'client_secret': "bUlMlOLNfq6Nh-OXjXMmSXvA",
	   'redirect_uri': "https://final-198415.appspot.com/oauth",
...
class MainPage(webapp2.RequestHandler):
  def get(self):
    ...
    self.response.write('<a href="https://accounts.google.com/o/oauth2/v2/auth?response_type=code&client_id=966293361107-32as5ricq9g1gu30utfo13ahbbrd84hd.apps.googleusercontent.com&redirect_uri=https://final-198415.appspot.com/oauth&scope=email&state=' + new_id + '">Click here to log in to your Google account</a><br><br>')
    self.response.write('<a href="https://final-198415.appspot.com/privacy">Privacy Information</a>')
